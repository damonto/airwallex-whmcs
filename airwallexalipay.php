...
function airwallexalipay_MetaData()
{
    return [
...
function airwallexalipay_config()
{
    return [
        'FriendlyName' => [
            'Type' => 'System',
            'Value' => 'Airwallex Alipay',
        ],
        'clientId' => [
...
function airwallexalipay_link(array $params)
{
    ...
    $confirmed = $airwallex->intents()->confirm($intent['id'], 'alipaycn', [
        'flow' => 'webqr'
    ]);
...
function airwallexalipay_refund(array $params)
{
    $airwallex = new Airwallex($params['clientId'], $params['apiKey']);
